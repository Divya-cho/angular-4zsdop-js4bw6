...
export class ProductList {
  ...
  TotalProd = this.products.length;
  TotalInStock = this.products.filter((i) => i.is_in_inventory == true).length;
  TotalOutOfStock = this.products.filter((i) => i.is_in_inventory == false)
    .length;

  selectedFilterRadioButton: string = 'all';
  onRadioButtonChanged(value: string) {
